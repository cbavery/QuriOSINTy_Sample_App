...
urlpatterns = [
    ...
    path('task/', views.task_list, name="task_list"), # URL to view all tasks (task list page)
    ...
    path('response/add/', views.add_response, name="add_response"), # URL to add a new response for a given task ID
